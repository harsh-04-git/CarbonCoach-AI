...
export interface CarbonProfile {
  ...
  breakdownPercentages: EmissionBreakdown;
}
...
export interface PersonaPreset extends CarbonAuditInput {
  name: string;
  description: string;
}

export interface PersonaPresets {
  student_commuter: PersonaPreset;
  working_professional: PersonaPreset;
  family_household: PersonaPreset;
}

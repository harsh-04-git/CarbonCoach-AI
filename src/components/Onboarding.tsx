    ...
    >
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full border border-emerald-100 text-sm font-semibold mb-4">
          <Sparkles className="w-4 h-4 text-emerald-600" /> AI Carbon &amp;
          Utility Bill Savings Active
        </div>
        ...
        <p className="text-base text-slate-600 max-w-2xl mx-auto font-sans leading-relaxed">
          Most carbon calculators stop at numbers. CarbonCoach AI helps you make
          practical, low-cost lifestyle decisions that maximize your carbon
          reduction with minimal effort.
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-6 pt-6 border-t border-emerald-100 text-center">
        <div className="p-4 bg-white rounded-2xl border border-emerald-100 shadow-sm shadow-emerald-50/50">
          <div className="flex justify-center mb-2 text-emerald-600 font-mono text-xl font-black">
            100%
          </div>
          ...
          <div className="text-xs text-slate-500 mt-1 font-sans leading-relaxed">
            All emissions math is grounded on verified data keys instead of LLM
            reasoning.
          </div>
        </div>
        <div className="p-4 bg-white rounded-2xl border border-emerald-100 shadow-sm shadow-emerald-50/50">
          ...
          <div className="text-xs text-slate-500 mt-1 font-sans leading-relaxed">
            No private data leaves your device. Built with strict input
            sanitization.
          </div>
        </div>
        <div className="p-4 bg-white rounded-2xl border border-emerald-100 shadow-sm shadow-emerald-50/50">
          ...
          <div className="text-xs text-slate-500 mt-1 font-sans leading-relaxed">
            Ultra lightweight under 10MB runtime with CSS layouts.
          </div>
        </div>
      </div>
    </div>
